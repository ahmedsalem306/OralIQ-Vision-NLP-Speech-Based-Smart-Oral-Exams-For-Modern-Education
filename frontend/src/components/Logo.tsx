    ...
    return (
        <div className={`flex items-center gap-3 ${className}`} style={{ flexShrink: 0 }}>
            ...
            <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Mic body */}
                <rect x="39" y="52" width="22" height="17" rx="4" fill="rgba(207,163,85,0.08)" stroke="url(#logoGrad)" strokeWidth="1.5" />
                ...
                {/* Dots — gold tones */}
                <circle cx="38" cy="38" r="2.5" fill="#cfa355" />
                <circle cx="62" cy="38" r="2.5" fill="#e8c97a" />
            ...
            {showText && (
                <div className="flex flex-col leading-none">
                    <span style={{
                        ...
                        filter: "drop-shadow(0 0 10px rgba(207,163,85,0.3))",
                    }}>
                        OralIQ
                    </span>
                    {showSubtitle && (
