...
export default function ExamDone() {
    return (
        <div style={{ minHeight: "100vh", background: "#0a0a0a", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem", textAlign: "center", backgroundImage: "radial-gradient(ellipse at 50% 30%, rgba(0,212,170,0.08) 0%, transparent 60%)" }}>
